...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        String db_nguoidung ="Create table NguoiDung(maTT text primary key,taikhoan2 text,matkhau2 text)";
        ...
        sqLiteDatabase.execSQL("INSERT INTO NguoiDung VALUES(1,'huy','huy'),(2,'hung','123ab'),(3,'ab','cd')");
    }
